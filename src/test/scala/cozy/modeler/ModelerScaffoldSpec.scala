  ...
  "CML modeler scaffold generation" should {
    "generate CAR project scaffolds" which {
      "car-sbt-project generates sbt project scaffold" in {
        ...
        buildsbtcontent should include ("resolvers += Resolver.defaultLocal")
        buildsbtcontent should not include ("useCoursier := false")
        buildsbtcontent should not include ("Resolver.mavenLocal")
        buildsbtcontent should not include ("Local Ivy")
        pluginssbtcontent should include ("resolvers += Resolver.defaultLocal")
        pluginssbtcontent should not include ("Resolver.mavenLocal")
        ...
        buildsbtcontent should not include ("--runtime")
        buildsbtcontent should not include ("""ProjectYamlBuild.requiredValue(cozyProjectMetadata.value, "build.cozyVersion")""")
      ...
      "car-sbt-project generates CAR+SAR application scaffold when style is car-sar" in {
        ...
        rootbuildcontent should include ("resolvers += Resolver.defaultLocal")
        rootbuildcontent should not include ("useCoursier := false")
        rootbuildcontent should not include ("Resolver.mavenLocal")
