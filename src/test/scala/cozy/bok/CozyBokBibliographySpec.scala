    ...
    "consume SmartDox bibliography metadata" which {
      "render a Bibliography dashboard and connect Home, Category, and Term Hub navigation" in {
        _with_temp_dir("cozy-bok-bibliography") { dir =>
          ...
          bibliography should include("""<body class="article bok-dashboard-theme-paper">""")
          bibliography should include("""class="body body-dashboard bok-bibliography-body"""")
          bibliography should include("""class="bok-dashboard-shell bok-bibliography-dashboard"""")
          bibliography should include("""class="bok-dashboard-hero"""")
          bibliography should include("""class="bok-bibliography-grid"""")
          bibliography should include("""class="bok-bibliography-tile"""")
          ...
          bibliography should not include ("""class="doc bok-special-doc"""")
          ...
          detail should include("""<body class="article">""")
          detail should include("""class="doc bok-bibliography-entry"""")
          ...
          detail should include("""class="table bok-bibliography-metadata-table"""")
          detail should include("""<th scope="row">ID</th><td><code>bib:design-patterns</code></td>""")
          detail should include("""<th scope="row">Key</th><td><code>gamma1995designpatterns</code></td>""")
          detail should not include ("""bok-dashboard-theme-paper""")
          detail should not include ("""class="body body-dashboard""")
          detail should not include ("<dl>")
