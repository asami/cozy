...
libraryDependencies += "org.goldenport" %% "goldenport-cncf" % sys.props.getOrElse("cncf.version", "0.4.13")
dependencyOverrides += "org.goldenport" %% "goldenport-cncf" % sys.props.getOrElse("cncf.version", "0.4.13")
SBTPATCH
