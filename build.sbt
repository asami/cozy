...
lazy val cncfVersion = "0.4.4"

lazy val simpleModelingModelVersion = "0.1.4"
...
libraryDependencies += "org.goldenport" %% "kaleidox" % "0.6.11"

libraryDependencies += "org.simplemodeling" %% "simplemodeler" % "1.1.14"
