...
libraryDependencies += "org.goldenport" %% "kaleidox" % "0.4.14"

libraryDependencies += "org.simplemodeling" %% "simplemodeler" % "1.0.5"

libraryDependencies += "org.goldenport" %% "arcadia" % "0.2.10"
