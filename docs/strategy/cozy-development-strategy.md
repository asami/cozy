...
| DEV-025 | `docs/journal/2026/09/2026-09-12-phase-58.1-document-summary-description-dsl-decision.md`; user-approved Phase 58.1 creation on 2026-09-12 | Add media-independent complete-document and summary-slide-level authoring DSLs over the recursive Content Core, separate localized content from renderer chrome, and prove both with strict Article 9 Japanese review projections that preserve semantically distinct Step Flow and local Structure. | NEW_PHASE | [Phase 58.1](../phase/phase-58.1.md) IN_PROGRESS | ADOPTED |
