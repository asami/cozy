...
Phase 23 spans CNCF, Cozy, CNCF Launcher, and Textus Launcher while keeping
...
## Stage 23.1: CNCF Skill Bundle Contract

Stage Status:

- Current status: PLANNED
- Owner: CNCF
- Checklist basis: `SK23-01`
...
## Stage 23.2: Cozy Validation and CAR Projection

Stage Status:

- Current status: PLANNED
- Owner: Cozy
- Checklist basis: `SK23-02`
...
## Stage 23.3: Development Installation

Stage Status:

- Current status: PLANNED
- Owner: CNCF Launcher
- Checklist basis: `SK23-03`
...
## Stage 23.4: Published Installation

Stage Status:

- Current status: PLANNED
- Owner: Textus Launcher
- Checklist basis: `SK23-04`
...
## Stage 23.5: Component Repository and End-to-End Use

Stage Status:

- Current status: PLANNED
- Owner: Cozy BoK / component driver project
- Checklist basis: `SK23-05` and `SK23-06`
...
Phase 23 closes when CNCF has a stable executable manifest contract, Cozy can
