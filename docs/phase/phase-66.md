# Phase 66: Generalized Composite StateMachine Semantic Artifact
...
Its downstream consumer is CNCF Phase 89. Phase 66 owns production of the
...
Phase 66 remains planned but must not start until both conditions hold:
...
66.1. Split only if the new bounded plan requires it.
...
| ID | Outcome | Status |
| --- | --- | --- |
| CSA-66-01 | Freeze the semantic artifact domain model, identity/version rules, and encoding boundary from a concrete consumer requirement. | planned |
| CSA-66-02 | Project constituents, configuration, typed rules, actions, and exact provenance from the Cozy IR. | planned |
| CSA-66-03 | Produce deterministic artifact encoding and typed producer diagnostics. | planned |
| CSA-66-04 | Add positive, rejection, determinism, and compatibility executable specifications plus a consumer handoff. | planned |
...
CSA-66-04 produces the exact input accepted by CNCF Phase 89. CNCF must not
...
work. Phase 66 neither accepts nor rejects those changes and must not absorb
...
must use that released handoff first and may not block on Phase 66.
...
stable first sm-workflow vertical slice
  ...
  -> Cozy Phase 66 producer artifact
...
- Pre-authorizing a Phase 66.1 split or a repository-full validation schedule.

## Completion

When the entry condition is eventually satisfied, completion requires every
item in [Phase 66 Checklist](phase-66-checklist.md), focused and full validation
...
- [Phase 66 future checklist](phase-66-checklist.md)
- [Superseded Phase 66.1 split record](phase-66.1.md)
