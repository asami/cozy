...
5. KnowledgeHub固有generatorにせず、Cozyの汎用Dart targetとして設計する。
...
Concrete HTTP client implementation may remain hand-written or separately generated; Phase 55 should first fix the typed boundary.
...
- arbitrary hand-written Dart preservation/merging in Phase 55.
