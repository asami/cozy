...
- Evidence: the source has 1,848 lines and owns independently changing CAR,
...
- Proposed hygiene boundary: first record a responsibility map, then extract
  cohesive scaffold emitters without changing generated bytes, public APIs, or
  CLI behavior; validate `ModelerScaffoldSpec` and the affected scripted gates.
